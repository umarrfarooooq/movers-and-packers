...
const Offices = () =>{
    return(
        <>
            <div className="py-8 sm:py-12 md:py-16 lg:py-20" style={{background:'linear-gradient(90deg, rgba(5,205,255,.15) 0%, rgba(0,149,181,.1) 80%)'}}>
                <section className="container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        <div className="flex flex-col gap-4 shadow-lg p-4 bg-[#F5F5F5] rounded-2xl">
